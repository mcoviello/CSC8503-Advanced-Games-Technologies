...
namespace NCL {
	...
	public:
		...
		static void DrawCube(const Vector3& centre, const Vector3& halfSizes, const Vector4& colour = Vector4(1, 1, 1, 1), float time = 0.0f);
		static void DrawCircle(const Vector3& centre, const float& radius, const Vector4& colour = Vector4(1, 1, 1, 1), float time = 0.0f);
